...
PICMAN was originally written by:
...
The following people have contributed code to PICMAN:
...
The following people have contributed art to PICMAN:
...
The following people have helped to document PICMAN:
