...
typedef void (* PicmanRunBrushCallback)   (const gchar          *brush_name,
                                         gdouble               opacity,
                                         gint                  spacing,
...
const gchar * picman_brush_select_new     (const gchar          *title,
                                         ...
                                         gpointer              data);
void          picman_brush_select_destroy (const gchar          *brush_callback);
