 ...
 * call must be used in conjunction with a picman_image_undo_group_end()
 * call.
 *
 * Returns: TRUE on success.
 **/
gboolean
picman_image_undo_group_start (gint32 image_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gboolean success = TRUE;

  return_vals = picman_run_procedure ("picman-image-undo-group-start",
                                    &nreturn_vals,
...
/**
 * picman_image_undo_group_end:
 * @image_ID: The ID of the image in which to close an undo group.
 *
 * Finish a group undo.
 *
 * This function must be called once for each
 * picman_image_undo_group_start() call that is made.
 *
 * Returns: TRUE on success.
 **/
gboolean
picman_image_undo_group_end (gint32 image_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gboolean success = TRUE;

  return_vals = picman_run_procedure ("picman-image-undo-group-end",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_END);
 ...
 * picman_image_undo_disable() or picman_image_undo_freeze().
 *
 * Returns: TRUE if undo is enabled for this image.
 **/
gboolean
picman_image_undo_is_enabled (gint32 image_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gboolean enabled = FALSE;

  return_vals = picman_run_procedure ("picman-image-undo-is-enabled",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_END);
 ...
 * conjunction with picman_image_undo_enable() to temporarily disable an
 ...
 **/
gboolean
picman_image_undo_disable (gint32 image_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gboolean disabled = FALSE;

  return_vals = picman_run_procedure ("picman-image-undo-disable",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_END);
 ...
 * conjunction with picman_image_undo_disable() to temporarily disable an
 * image undo stack.
 *
 * Returns: TRUE if the image undo has been enabled.
 **/
gboolean
picman_image_undo_enable (gint32 image_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gboolean enabled = FALSE;

  return_vals = picman_run_procedure ("picman-image-undo-enable",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_END);
 ...
 * operations to ignore their undo steps. This is generally called in
 * conjunction with picman_image_undo_thaw() to temporarily disable an
 * image undo stack. This is advantageous because saving undo steps can
 * be time and memory intensive. picman_image_undo_freeze() /
 * picman_image_undo_thaw() and picman_image_undo_disable() /
 * picman_image_undo_enable() differ in that the former does not free up
 ...
 **/
gboolean
picman_image_undo_freeze (gint32 image_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gboolean frozen = FALSE;

  return_vals = picman_run_procedure ("picman-image-undo-freeze",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_END);
 ...
 * operations to store their undo steps. This is generally called in
 * conjunction with picman_image_undo_freeze() to temporarily freeze an
 * image undo stack. picman_image_undo_thaw() does NOT free the undo
 * stack as picman_image_undo_enable() does, so is suited for situations
 ...
 **/
gboolean
picman_image_undo_thaw (gint32 image_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gboolean thawed = FALSE;

  return_vals = picman_run_procedure ("picman-image-undo-thaw",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_END);
