 ...
 * added to the image using picman_image_insert_vectors().
 *
 ...
 **/
gint32
picman_vectors_new (gint32       image_ID,
                  const gchar *name)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-new",
                                    &nreturn_vals,
 ...
 * needs to be added to the image using picman_image_insert_vectors().
 *
 ...
 **/
gint32
picman_vectors_new_from_text_layer (gint32 image_ID,
                                  gint32 layer_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-new-from-text-layer",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
 ...
 **/
gint32
picman_vectors_copy (gint32 vectors_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  gint32 vectors_copy_ID = -1;

  return_vals = picman_run_procedure ("picman-vectors-copy",
                                    &nreturn_vals,
 ...
 **/
gint *
picman_vectors_get_strokes (gint32  vectors_ID,
                          gint   *num_strokes)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-get-strokes",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_END);
 ...
 **/
gdouble
picman_vectors_stroke_get_length (gint32  vectors_ID,
                                gint    stroke_id,
                                gdouble precision)
{
  PicmanParam *return_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-get-length",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_FLOAT, precision,
                                    PICMAN_PDB_END);
...
/**
 * picman_vectors_stroke_get_point_at_dist:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 ...
 **/
gboolean
picman_vectors_stroke_get_point_at_dist (gint32    vectors_ID,
                                       gint      stroke_id,
                                       gdouble   dist,
                                       gdouble   precision,
                                       gdouble  *x_point,
                                       ...
                                       gboolean *valid)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-get-point-at-dist",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_FLOAT, dist,
                                    PICMAN_PDB_FLOAT, precision,
                                    PICMAN_PDB_END);
 ...
 **/
gboolean
picman_vectors_remove_stroke (gint32 vectors_ID,
                            gint   stroke_id)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-remove-stroke",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_END);
 ...
 **/
gboolean
picman_vectors_stroke_close (gint32 vectors_ID,
                           gint   stroke_id)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-close",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_END);
...
/**
 * picman_vectors_stroke_translate:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 ...
 **/
gboolean
picman_vectors_stroke_translate (gint32 vectors_ID,
                               gint   stroke_id,
                               gint   off_x,
                               gint   off_y)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-translate",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_INT32, off_x,
                                    PICMAN_PDB_INT32, off_y,
                                    PICMAN_PDB_END);
 ...
 **/
gboolean
picman_vectors_stroke_scale (gint32  vectors_ID,
                           gint    stroke_id,
                           gdouble scale_x,
                           gdouble scale_y)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-scale",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
 ...
 **/
gboolean
picman_vectors_stroke_rotate (gint32  vectors_ID,
                            gint    stroke_id,
                            gdouble center_x,
                            gdouble center_y,
                            gdouble angle)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-rotate",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
 ...
 **/
gboolean
picman_vectors_stroke_flip (gint32              vectors_ID,
                          gint                stroke_id,
                          ...
                          gdouble             axis)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-flip",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
...
/**
 * picman_vectors_stroke_flip_free:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 ...
 **/
gboolean
picman_vectors_stroke_flip_free (gint32  vectors_ID,
                               gint    stroke_id,
                               gdouble x1,
                               gdouble y1,
                               gdouble x2,
                               gdouble y2)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-flip-free",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_FLOAT, x1,
...
/**
 * picman_vectors_stroke_get_points:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 ...
 * coordinates returned depends on the type of the stroke. For Picman 2.4
 * this is always a bezier stroke, where the coordinates are the
 * control points.
 *
 * Returns: type of the stroke (always PICMAN_VECTORS_STROKE_TYPE_BEZIER
 * for now).
 *
 * Since: PICMAN 2.4
 **/
PicmanVectorsStrokeType
picman_vectors_stroke_get_points (gint32     vectors_ID,
                                gint       stroke_id,
                                gint      *num_points,
                                ...
                                gboolean  *closed)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  PicmanVectorsStrokeType type = 0;

  return_vals = picman_run_procedure ("picman-vectors-stroke-get-points",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_END);
 ...
 * @vectors_ID: The vectors object.
 * @type: type of the stroke (always PICMAN_VECTORS_STROKE_TYPE_BEZIER for now).
 ...
 * type PICMAN_VECTORS_STROKE_TYPE_BEZIER are supported. The control
 ...
 **/
gint
picman_vectors_stroke_new_from_points (gint32                 vectors_ID,
                                     ...
                                     gboolean               closed)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-new-from-points",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, type,
                                    PICMAN_PDB_INT32, num_points,
                                    PICMAN_PDB_FLOATARRAY, controlpoints,
                                    PICMAN_PDB_INT32, closed,
                                    PICMAN_PDB_END);
...
/**
 * picman_vectors_stroke_interpolate:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 * @precision: The precision used for the approximation.
 ...
 **/
gdouble *
picman_vectors_stroke_interpolate (gint32    vectors_ID,
                                 gint      stroke_id,
                                 gdouble   precision,
                                 gint     *num_coords,
                                 gboolean *closed)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-stroke-interpolate",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_FLOAT, precision,
...
/**
 * picman_vectors_bezier_stroke_new_moveto:
 * @vectors_ID: The vectors object.
 ...
 **/
gint
picman_vectors_bezier_stroke_new_moveto (gint32  vectors_ID,
                                       gdouble x0,
                                       gdouble y0)
{
  PicmanParam *return_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-bezier-stroke-new-moveto",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_FLOAT, x0,
                                    PICMAN_PDB_FLOAT, y0,
...
/**
 * picman_vectors_bezier_stroke_lineto:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 ...
 **/
gboolean
picman_vectors_bezier_stroke_lineto (gint32  vectors_ID,
                                   gint    stroke_id,
                                   gdouble x0,
                                   gdouble y0)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-bezier-stroke-lineto",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_FLOAT, x0,
...
/**
 * picman_vectors_bezier_stroke_conicto:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 ...
 **/
gboolean
picman_vectors_bezier_stroke_conicto (gint32  vectors_ID,
                                    gint    stroke_id,
                                    gdouble x0,
                                    gdouble y0,
                                    gdouble x1,
                                    gdouble y1)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-bezier-stroke-conicto",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_FLOAT, x0,
...
/**
 * picman_vectors_bezier_stroke_cubicto:
 * @vectors_ID: The vectors object.
 * @stroke_id: The stroke ID.
 ...
 **/
gboolean
picman_vectors_bezier_stroke_cubicto (gint32  vectors_ID,
                                    gint    stroke_id,
                                    gdouble x0,
                                    gdouble y0,
                                    gdouble x1,
                                    ...
                                    gdouble y2)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-bezier-stroke-cubicto",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_INT32, stroke_id,
                                    PICMAN_PDB_FLOAT, x0,
...
/**
 * picman_vectors_bezier_stroke_new_ellipse:
 * @vectors_ID: The vectors object.
 ...
 **/
gint
picman_vectors_bezier_stroke_new_ellipse (gint32  vectors_ID,
                                        gdouble x0,
                                        gdouble y0,
                                        gdouble radius_x,
                                        gdouble radius_y,
                                        gdouble angle)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-bezier-stroke-new-ellipse",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_FLOAT, x0,
                                    PICMAN_PDB_FLOAT, y0,
                                    PICMAN_PDB_FLOAT, radius_x,
                                    PICMAN_PDB_FLOAT, radius_y,
                                    PICMAN_PDB_FLOAT, angle,
                                    PICMAN_PDB_END);
 ...
 **/
gboolean
picman_vectors_to_selection (gint32         vectors_ID,
                           ...
                           gdouble        feather_radius_y)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-to-selection",
                                    &nreturn_vals,
                                    PICMAN_PDB_VECTORS, vectors_ID,
...
/**
 * picman_vectors_import_from_file:
 * @image_ID: The image.
 ...
 **/
gboolean
picman_vectors_import_from_file (gint32        image_ID,
                               ...
                               gint32      **vectors_ids)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-import-from-file",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
...
/**
 * picman_vectors_import_from_string:
 * @image_ID: The image.
 ...
 *
 * This procedure works like picman_vectors_import_from_file() but takes
 * a string rather than reading the SVG from a file. This allows you to
 * write scripts that generate SVG and feed it to PICMAN.
 *
 * Returns: TRUE on success.
 *
 * Since: PICMAN 2.4
 **/
gboolean
picman_vectors_import_from_string (gint32        image_ID,
                                 const gchar  *string,
                                 gint          length,
                                 gboolean      merge,
                                 gboolean      scale,
                                 ...
                                 gint32      **vectors_ids)
{
  ...
  return_vals = picman_run_procedure ("picman-vectors-import-from-string",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_STRING, string,
                                    PICMAN_PDB_INT32, length,
                                    PICMAN_PDB_INT32, merge,
                                    PICMAN_PDB_INT32, scale,
                                    PICMAN_PDB_END);
 ...
 * application, or later reloaded into PICMAN. If you pass 0 as the
 ...
 **/
gboolean
picman_vectors_export_to_file (gint32       image_ID,
                             const gchar *filename,
                             gint32       vectors_ID)
{
  PicmanParam *return_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-export-to-file",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_STRING, filename,
                                    PICMAN_PDB_VECTORS, vectors_ID,
...
/**
 * picman_vectors_export_to_string:
 * @image_ID: The image.
 * @vectors_ID: The vectors object to save, or 0 for all in the image.
 *
 * Save a path as an SVG string.
 *
 * This procedure works like picman_vectors_export_to_file() but creates
 ...
 **/
gchar *
picman_vectors_export_to_string (gint32 image_ID,
                               gint32 vectors_ID)
{
  PicmanParam *return_vals;
  gint nreturn_vals;
  ...
  return_vals = picman_run_procedure ("picman-vectors-export-to-string",
                                    &nreturn_vals,
                                    PICMAN_PDB_IMAGE, image_ID,
                                    PICMAN_PDB_VECTORS, vectors_ID,
                                    PICMAN_PDB_END);
