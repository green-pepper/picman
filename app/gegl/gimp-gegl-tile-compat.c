...
#include "picman-gegl-tile-compat.h"


gint
picman_gegl_buffer_get_n_tile_rows (GeglBuffer *buffer,
                                  gint        tile_height)
{
...
gint
picman_gegl_buffer_get_n_tile_cols (GeglBuffer *buffer,
                                  gint        tile_width)
{
...
gboolean
picman_gegl_buffer_get_tile_rect (GeglBuffer    *buffer,
                                gint           tile_width,
                                gint           tile_height,
                                gint           tile_num,
                                GeglRectangle *rect)
{
  ...
  n_tile_rows    = picman_gegl_buffer_get_n_tile_rows (buffer, tile_height);
  n_tile_columns = picman_gegl_buffer_get_n_tile_cols (buffer, tile_width);
