...
static gint   picman_pixbuf_format_compare (GdkPixbufFormat *a,
                                          GdkPixbufFormat *b);
...
GSList *
picman_pixbuf_get_formats (void)
{
  return g_slist_sort (gdk_pixbuf_get_formats (),
                       (GCompareFunc) picman_pixbuf_format_compare);
}

void
picman_pixbuf_targets_add (GtkTargetList *target_list,
                         guint          info,
                         gboolean       writable)
{
  GSList *formats;
  ...
  formats = picman_pixbuf_get_formats ();
...
void
picman_pixbuf_targets_remove (GtkTargetList *target_list)
{
  GSList *formats;
  GSList *list;
...
static gint
picman_pixbuf_format_compare (GdkPixbufFormat *a,
                            GdkPixbufFormat *b)
{
