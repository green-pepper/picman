...
static const PicmanActionEntry palettes_actions[] =
{
  { "palettes-popup", PICMAN_STOCK_PALETTE,
...
void
palettes_actions_setup (PicmanActionGroup *group)
{
  picman_action_group_add_actions (group, "palettes-action",
                                 palettes_actions,
                                 G_N_ELEMENTS (palettes_actions));

  picman_action_group_add_string_actions (group, "palettes-action",
...
void
palettes_actions_update (PicmanActionGroup *group,
                         gpointer         user_data)
{
...
#define SET_SENSITIVE(action,condition) \
  ...
  SET_SENSITIVE ("palettes-duplicate",     palette && PICMAN_DATA_GET_CLASS (data)->duplicate);
  SET_SENSITIVE ("palettes-merge",         FALSE); /* FIXME palette && PICMAN_IS_CONTAINER_LIST_VIEW (editor->view)); */
  SET_SENSITIVE ("palettes-copy-location", palette && filename);
  SET_SENSITIVE ("palettes-delete",        palette && picman_data_is_deletable (data));
