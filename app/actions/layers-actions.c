...
static const PicmanActionEntry layers_actions[] =
{
  { "layers-popup", PICMAN_STOCK_LAYERS,
  ...
  { "layers-opacity-menu",           PICMAN_STOCK_TRANSPARENCY,
    NC_("layers-action", "_Opacity")      },
  { "layers-mode-menu",              PICMAN_STOCK_TOOL_PENCIL,
    NC_("layers-action", "Layer _Mode")   },

  { "layers-text-tool", PICMAN_STOCK_TOOL_TEXT,
  ...
  { "layers-new-from-visible", NULL,
    ...
    PICMAN_HELP_LAYER_NEW_FROM_VISIBLE },
  ...
  { "layers-duplicate", PICMAN_STOCK_DUPLICATE,
  ...
  { "layers-raise-to-top", GTK_STOCK_GOTO_TOP,
    ...
    PICMAN_HELP_LAYER_RAISE_TO_TOP },
  ...
  { "layers-lower-to-bottom", GTK_STOCK_GOTO_BOTTOM,
    ...
    PICMAN_HELP_LAYER_LOWER_TO_BOTTOM },

  { "layers-anchor", PICMAN_STOCK_ANCHOR,
    ...
    PICMAN_HELP_LAYER_ANCHOR },

  { "layers-merge-down", PICMAN_STOCK_MERGE_DOWN,
  ...
  { "layers-text-discard", PICMAN_STOCK_TOOL_TEXT,
    ...
    PICMAN_HELP_LAYER_TEXT_DISCARD },

  { "layers-text-to-vectors", PICMAN_STOCK_TOOL_TEXT,
    ...
    PICMAN_HELP_LAYER_TEXT_TO_PATH },

  { "layers-text-along-vectors", PICMAN_STOCK_TOOL_TEXT,
    ...
    PICMAN_HELP_LAYER_TEXT_ALONG_PATH },

  { "layers-resize", PICMAN_STOCK_RESIZE,
    ...
    PICMAN_HELP_LAYER_RESIZE },

  { "layers-resize-to-image", PICMAN_STOCK_LAYER_TO_IMAGESIZE,
    ...
    PICMAN_HELP_LAYER_RESIZE_TO_IMAGE },

  { "layers-scale", PICMAN_STOCK_SCALE,
    ...
    PICMAN_HELP_LAYER_SCALE },

  { "layers-crop-to-selection", PICMAN_STOCK_TOOL_CROP,
    ...
    PICMAN_HELP_LAYER_CROP },

  { "layers-crop-to-content", PICMAN_STOCK_TOOL_CROP,
  ...
  { "layers-mask-add", PICMAN_STOCK_LAYER_MASK,
  ...
  { "layers-alpha-add", PICMAN_STOCK_TRANSPARENCY,
  ...
  { "layers-alpha-remove", NULL,
    ...
    PICMAN_HELP_LAYER_ALPHA_REMOVE }
};

static const PicmanToggleActionEntry layers_toggle_actions[] =
{
  { "layers-lock-alpha", PICMAN_STOCK_TRANSPARENCY,
  ...
  { "layers-mask-edit", GTK_STOCK_EDIT,
    ...
    FALSE,
    PICMAN_HELP_LAYER_MASK_EDIT },

  { "layers-mask-show", PICMAN_STOCK_VISIBLE,
    NC_("layers-action", "S_how Layer Mask"), NULL, NULL,
    G_CALLBACK (layers_mask_show_cmd_callback),
    FALSE,
    PICMAN_HELP_LAYER_MASK_SHOW },
  ...
  { "layers-mask-disable", NULL,
    ...
    FALSE,
    PICMAN_HELP_LAYER_MASK_DISABLE }
};

static const PicmanEnumActionEntry layers_mask_apply_actions[] =
{
  { "layers-mask-apply", NULL,
    ...
    PICMAN_MASK_APPLY, FALSE,
    PICMAN_HELP_LAYER_MASK_APPLY },
  ...
  { "layers-mask-delete", GTK_STOCK_DELETE,
    ...
    PICMAN_MASK_DISCARD, FALSE,
    PICMAN_HELP_LAYER_MASK_DELETE }
};

static const PicmanEnumActionEntry layers_mask_to_selection_actions[] =
{
  { "layers-mask-selection-replace", PICMAN_STOCK_SELECTION_REPLACE,
    ...
    PICMAN_HELP_LAYER_MASK_SELECTION_REPLACE },

  { "layers-mask-selection-add", PICMAN_STOCK_SELECTION_ADD,
    ...
    PICMAN_HELP_LAYER_MASK_SELECTION_ADD },

  { "layers-mask-selection-subtract", PICMAN_STOCK_SELECTION_SUBTRACT,
    ...
    PICMAN_HELP_LAYER_MASK_SELECTION_SUBTRACT },

  { "layers-mask-selection-intersect", PICMAN_STOCK_SELECTION_INTERSECT,
    ...
    PICMAN_HELP_LAYER_MASK_SELECTION_INTERSECT }
};

static const PicmanEnumActionEntry layers_alpha_to_selection_actions[] =
{
  { "layers-alpha-selection-replace", PICMAN_STOCK_SELECTION_REPLACE,
    NC_("layers-action", "Al_pha to Selection"), NULL,
    NC_("layers-action",
        "Replace the selection with the layer's alpha channel"),
    PICMAN_CHANNEL_OP_REPLACE, FALSE,
    PICMAN_HELP_LAYER_ALPHA_SELECTION_REPLACE },

  { "layers-alpha-selection-add", PICMAN_STOCK_SELECTION_ADD,
    NC_("layers-action", "A_dd to Selection"), NULL,
    NC_("layers-action",
        "Add the layer's alpha channel to the current selection"),
    PICMAN_CHANNEL_OP_ADD, FALSE,
    PICMAN_HELP_LAYER_ALPHA_SELECTION_ADD },

  { "layers-alpha-selection-subtract", PICMAN_STOCK_SELECTION_SUBTRACT,
    NC_("layers-action", "_Subtract from Selection"), NULL,
    NC_("layers-action",
        "Subtract the layer's alpha channel from the current selection"),
    PICMAN_CHANNEL_OP_SUBTRACT, FALSE,
    PICMAN_HELP_LAYER_ALPHA_SELECTION_SUBTRACT },

  { "layers-alpha-selection-intersect", PICMAN_STOCK_SELECTION_INTERSECT,
    NC_("layers-action", "_Intersect with Selection"), NULL,
    NC_("layers-action",
        "Intersect the layer's alpha channel with the current selection"),
    PICMAN_CHANNEL_OP_INTERSECT, FALSE,
    PICMAN_HELP_LAYER_ALPHA_SELECTION_INTERSECT }
};

static const PicmanEnumActionEntry layers_select_actions[] =
{
  ...
  { "layers-select-next", NULL,
    ...
    PICMAN_HELP_LAYER_NEXT }
};

static const PicmanEnumActionEntry layers_opacity_actions[] =
{
  { "layers-opacity-set", PICMAN_STOCK_TRANSPARENCY,
    "Set Opacity", NULL, NULL,
    PICMAN_ACTION_SELECT_SET, TRUE,
    PICMAN_HELP_LAYER_OPACITY },
  { "layers-opacity-transparent", PICMAN_STOCK_TRANSPARENCY,
    "Completely Transparent", NULL, NULL,
    PICMAN_ACTION_SELECT_FIRST, FALSE,
    PICMAN_HELP_LAYER_OPACITY },
  { "layers-opacity-opaque", PICMAN_STOCK_TRANSPARENCY,
    "Completely Opaque", NULL, NULL,
    PICMAN_ACTION_SELECT_LAST, FALSE,
    PICMAN_HELP_LAYER_OPACITY },
  { "layers-opacity-decrease", PICMAN_STOCK_TRANSPARENCY,
    "More Transparent", NULL, NULL,
    PICMAN_ACTION_SELECT_PREVIOUS, FALSE,
    PICMAN_HELP_LAYER_OPACITY },
  { "layers-opacity-increase", PICMAN_STOCK_TRANSPARENCY,
    "More Opaque", NULL, NULL,
    PICMAN_ACTION_SELECT_NEXT, FALSE,
    PICMAN_HELP_LAYER_OPACITY },
  { "layers-opacity-decrease-skip", PICMAN_STOCK_TRANSPARENCY,
    "10% More Transparent", NULL, NULL,
    PICMAN_ACTION_SELECT_SKIP_PREVIOUS, FALSE,
    PICMAN_HELP_LAYER_OPACITY },
  { "layers-opacity-increase-skip", PICMAN_STOCK_TRANSPARENCY,
    "10% More Opaque", NULL, NULL,
    PICMAN_ACTION_SELECT_SKIP_NEXT, FALSE,
    PICMAN_HELP_LAYER_OPACITY }
};

static const PicmanEnumActionEntry layers_mode_actions[] =
{
  { "layers-mode-first", PICMAN_STOCK_TOOL_PENCIL,
    "First Layer Mode", NULL, NULL,
    PICMAN_ACTION_SELECT_FIRST, FALSE,
    PICMAN_HELP_LAYER_MODE },
  { "layers-mode-last", PICMAN_STOCK_TOOL_PENCIL,
    "Last Layer Mode", NULL, NULL,
    PICMAN_ACTION_SELECT_LAST, FALSE,
    PICMAN_HELP_LAYER_MODE },
  { "layers-mode-previous", PICMAN_STOCK_TOOL_PENCIL,
    "Previous Layer Mode", NULL, NULL,
    PICMAN_ACTION_SELECT_PREVIOUS, FALSE,
    PICMAN_HELP_LAYER_MODE },
  { "layers-mode-next", PICMAN_STOCK_TOOL_PENCIL,
 ...
 **/
static void
layers_actions_fix_tooltip (PicmanActionGroup *group,
                            const gchar     *action,
                            GdkModifierType  modifiers)
{
  ...
  old_hint = picman_action_group_get_action_tooltip (group,
                                                   action);
  ...
  picman_action_group_set_action_tooltip (group, action, new_hint);
  g_free (new_hint);
}

void
layers_actions_setup (PicmanActionGroup *group)
{
  ...
  picman_action_group_add_actions (group, "layers-action",
                                 layers_actions,
                                 G_N_ELEMENTS (layers_actions));

  picman_action_group_add_toggle_actions (group, "layers-action",
                                        layers_toggle_actions,
                                        G_N_ELEMENTS (layers_toggle_actions));

  picman_action_group_add_enum_actions (group, "layers-action",
...
void
layers_actions_update (PicmanActionGroup *group,
                       gpointer         data)
{
  PicmanImage     *image          = action_data_get_image (data);
  PicmanLayer     *layer          = NULL;
  PicmanLayerMask *mask           = NULL;     /*  layer mask             */
  ...
  if (image)
    {
      ...
      ac      = (picman_image_get_active_channel (image) != NULL);
      ...
      if (layer)
        {
          ...
          can_lock_alpha = picman_layer_can_lock_alpha (layer);
          alpha          = picman_drawable_has_alpha (PICMAN_DRAWABLE (layer));
          writable       = ! picman_item_is_content_locked (PICMAN_ITEM (layer));
          movable        = ! picman_item_is_position_locked (PICMAN_ITEM (layer));

          if (picman_viewable_get_children (PICMAN_VIEWABLE (layer)))
            children = TRUE;

          layer_list = picman_item_get_container_iter (PICMAN_ITEM (layer));
          ...
          if (list)
            {
              ...
              for (next_visible = next;
                ...
                {
                  if (picman_item_get_visible (next_visible->data))
                    {
                      /*  "next_visible" is actually "next_visible" and
                       *  "writable" and "not group"
                       */
                      if (picman_item_is_content_locked (next_visible->data) ||
                          picman_viewable_get_children (next_visible->data))
                        next_visible = NULL;
...
#define SET_LABEL(action,label) \
  ...
  SET_ACTIVE ("layers-mask-edit",    mask && picman_layer_get_edit_mask (layer));
  SET_ACTIVE ("layers-mask-show",    mask && picman_layer_get_show_mask (layer));
  SET_ACTIVE ("layers-mask-disable", mask && !picman_layer_get_apply_mask (layer));
