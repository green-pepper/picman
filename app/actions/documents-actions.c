...
static const PicmanActionEntry documents_actions[] =
{
  ...
  { "documents-copy-location", GTK_STOCK_COPY,
    ...
    PICMAN_HELP_DOCUMENT_COPY_LOCATION },
...
void
documents_actions_setup (PicmanActionGroup *group)
{
  picman_action_group_add_actions (group, "documents-action",
                                 documents_actions,
                                 G_N_ELEMENTS (documents_actions));
}

void
documents_actions_update (PicmanActionGroup *group,
                          gpointer         data)
{
  PicmanContext   *context;
  PicmanImagefile *imagefile = NULL;
