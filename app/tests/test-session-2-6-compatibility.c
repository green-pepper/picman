...
#define ADD_TEST(function) \
  g_test_add_func ("/picman-session-2-6-compatibility/" #function, function);


/**
 * Tests that a sessionrc and dockrc from PICMAN 2.6 is loaded and
 * written (thus also interpreted) like we expect.
 **/
static void
read_and_write_session_files (void)
{
  picman_test_session_load_and_write_session_files ("sessionrc-2-6",
                                                  "dockrc-2-6",
