...
static gchar * sanity_check_picman              (void);
...
sanity_check (void)
{
  gchar *abort_message = sanity_check_picman ();
...
static gchar *
sanity_check_picman (void)
{
  if (PICMAN_MAJOR_VERSION != picman_major_version ||
      PICMAN_MINOR_VERSION != picman_minor_version ||
      PICMAN_MICRO_VERSION != picman_micro_version)
    {
      return g_strdup_printf
        ("Libpicman version mismatch!\n\n"
         "The PICMAN binary cannot run with a libpicman version\n"
         "other than its own. This is PICMAN %d.%d.%d, but the\n"
         "libpicman version is %d.%d.%d.\n\n"
         "Maybe you have PICMAN versions in both /usr and /usr/local ?",
  ...
  if (mismatch)
    {
      return g_strdup_printf
        ("%s\n\n"
         "PICMAN requires GLib version %d.%d.%d or later.\n"
         "Installed GLib version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install PICMAN with an older GLib version.\n\n"
                                               ...
                                               CAIRO_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("The Cairo version being used is too old!\n\n"
         "PICMAN requires Cairo version %d.%d.%d or later.\n"
         "Installed Cairo version is %s.\n\n"
         "Somehow you or your software packager managed\n"
         "to install PICMAN with an older Cairo version.\n\n"
  ...
  if (mismatch)
    {
      ...
      return g_strdup_printf
        ("%s\n\n"
         "PICMAN requires Pango version %d.%d.%d or later.\n"
         "Installed Pango version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install PICMAN with an older Pango version.\n\n"
                    ...
                    (FC_REQUIRED_MICRO *     1)))
    {
      ...
      return g_strdup_printf
        ("The Fontconfig version being used is too old!\n\n"
         "PICMAN requires Fontconfig version %d.%d.%d or later.\n"
         "The Fontconfig version loaded by PICMAN is %d.%d.%d.\n\n"
                    ...
                    (FT_REQUIRED_MICRO *     1)))
    {
      return g_strdup_printf
        ("FreeType version too old!\n\n"
         "PICMAN requires FreeType version %d.%d.%d or later.\n"
         "Installed FreeType version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install PICMAN with an older FreeType version.\n\n"
                              ...
                              gdk_pixbuf_micro_version, GDK_PIXBUF_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("GdkPixbuf version too old!\n\n"
         "PICMAN requires GdkPixbuf version %d.%d.%d or later.\n"
         "Installed GdkPixbuf version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install PICMAN with an older GdkPixbuf version.\n\n"
                              ...
                              babl_micro_version, BABL_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("BABL version too old!\n\n"
         "PICMAN requires BABL version %d.%d.%d or later.\n"
         "Installed BABL version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install PICMAN with an older BABL version.\n\n"
                              ...
                              gegl_micro_version, GEGL_REQUIRED_MICRO))
    {
      return g_strdup_printf
        ("GEGL version too old!\n\n"
         "PICMAN requires GEGL version %d.%d.%d or later.\n"
         "Installed GEGL version is %d.%d.%d.\n\n"
         "Somehow you or your software packager managed\n"
         "to install PICMAN with an older GEGL version.\n\n"
...
sanity_check_filename_encoding (void)
{
  ...
  result = g_filename_to_utf8 (picman_directory (), -1, NULL, NULL, &error);

  if (! result)
    {
      gchar *msg =
        g_strdup_printf
        (_("The name of the directory holding the PICMAN user configuration "
