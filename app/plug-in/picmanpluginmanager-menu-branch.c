...
void
picman_plug_in_manager_menu_branch_exit (PicmanPlugInManager *manager)
{
  GSList *list;
  ...
  for (list = manager->menu_branches; list; list = list->next)
    {
      ...
      g_slice_free (PicmanPlugInMenuBranch, branch);
    }
...
void
picman_plug_in_manager_add_menu_branch (PicmanPlugInManager *manager,
                                      const gchar       *prog_name,
                                      const gchar       *menu_path,
                                      const gchar       *menu_label)
{
  PicmanPlugInMenuBranch *branch;
  ...
  branch = g_slice_new (PicmanPlugInMenuBranch);
...
GSList *
picman_plug_in_manager_get_menu_branches (PicmanPlugInManager *manager)
{
