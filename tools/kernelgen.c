 ...
 *
 * kernelgen -- Copyright (C) 2000 Sven Neumann <sven@picman.org>
 *
 ...
 *    the output to app/paint/picmanbrushcore-kernels.h.
 *
      ...
      char **argv)
{
  ...
  printf ("/* picmanbrushcore-kernels.h\n"
          " *\n"
          " *   This file was generated using kernelgen as found in the tools dir.\n");
  printf (" *   (threshold = %g)\n", THRESHOLD);
  printf (" */\n\n");
  printf ("#ifndef __PICMAN_BRUSH_CORE_KERNELS_H__\n");
  printf ("#define __PICMAN_BRUSH_CORE_KERNELS_H__\n\n");
  ...
  printf ("#endif /* __PICMAN_BRUSH_CORE_KERNELS_H__ */\n");
