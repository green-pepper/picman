...
"""
module-dependencies.py -- PICMAN library and core module dependency constructor
...
with dependencies between PICMAN library and core modules. Run it from
...
if not os.path.exists("app") or not os.path.exists("libpicman"):
    print("Must be run in source root!")
    exit(-1);


# This file lives in libpicman and is used by many low-level
...
# Write result
if True:
    dependency_graph.draw("devel-docs/picman-module-dependencies.svg", prog="dot")
else:
    dependency_graph.write("devel-docs/picman-module-dependencies.dot")
