...
#include "picmangradientmenu.h"
#include "picmangradientselectbutton.h"


/**
 * SECTION: picmangradientmenu
 * @title: picmangradientmenu
...
static void compat_callback           (PicmanGradientSelectButton *gradient_button,
...
/**
 * picman_gradient_select_widget_new:
 ...
 */
GtkWidget *
picman_gradient_select_widget_new (const gchar             *title,
                                 const gchar             *gradient_name,
                                 PicmanRunGradientCallback  callback,
                                 gpointer                 data)
{
  ...
  gradient_button = picman_gradient_select_button_new (title, gradient_name);
...
/**
 * picman_gradient_select_widget_close:
 * @widget: A gradient select widget.
 *
 * Closes the popup window associated with @widget.
 */
void
picman_gradient_select_widget_close (GtkWidget *widget)
{
...
/**
 * picman_gradient_select_widget_set:
 * @widget:        A gradient select widget.
 ...
 */
void
picman_gradient_select_widget_set (GtkWidget   *widget,
                                 const gchar *gradient_name)
{
  g_return_if_fail (widget != NULL);
...
static void
compat_callback (PicmanGradientSelectButton *gradient_button,
                 const gchar              *gradient_name,
                 gint                      width,
                 const gdouble            *grad_data,
                 gboolean                  dialog_closing,
