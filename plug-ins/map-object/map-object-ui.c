...
static void
zoomed_callback (PicmanZoomModel *model)
{
  mapvals.zoom = picman_zoom_model_get_factor (model);
               ...
               gpointer data)
{
  ...
  return (picman_drawable_is_rgb (drawable_id) &&
          !picman_drawable_is_indexed (drawable_id));
}
...
create_options_page (void)
{
  ...
  combo = picman_int_combo_box_new (_("Plane"),    MAP_PLANE,
                                  _("Sphere"),   MAP_SPHERE,
                                  _("Box"),      MAP_BOX,
                                  _("Cylinder"), MAP_CYLINDER,
                                  NULL);
  picman_int_combo_box_set_active (PICMAN_INT_COMBO_BOX (combo), mapvals.maptype);
  ...
  picman_help_set_help_data (combo, _("Type of object to map to"), NULL);
  ...
  spinbutton = picman_spin_button_new (&adj, mapvals.pixeltreshold,
...
create_light_page (void)
{
  ...
  combo = picman_int_combo_box_new (_("Point light"),       POINT_LIGHT,
  ...
  picman_help_set_help_data (combo, _("Type of light source to apply"), NULL);
  ...
  pointlightwid = picman_frame_new (_("Position"));
  ...
  spinbutton = picman_spin_button_new (&xadj, mapvals.lightsource.position.x,
  ...
  spinbutton = picman_spin_button_new (&yadj, mapvals.lightsource.position.y,
                                     -G_MAXFLOAT, G_MAXFLOAT,
                                     0.1, 1.0, 0.0, 0.0, 2);
  picman_table_attach_aligned (GTK_TABLE (table), 0, 1,
                             _("Y:"), 0.0, 0.5,
  ...
  spinbutton = picman_spin_button_new (&zadj, mapvals.lightsource.position.z,
                                     -G_MAXFLOAT, G_MAXFLOAT,
                                     0.1, 1.0, 0.0, 0.0, 2);
  ...
  dirlightwid = picman_frame_new (_("Direction Vector"));
  ...
  spinbutton = picman_spin_button_new (&adj, mapvals.lightsource.direction.x,
  ...
  spinbutton = picman_spin_button_new (&adj, mapvals.lightsource.direction.y,
                                     -1.0, 1.0, 0.01, 0.1, 0.0, 0.0, 2);
  picman_table_attach_aligned (GTK_TABLE (table), 0, 1,
                             _("Y:"), 0.0, 0.5,
                             spinbutton, 1, TRUE);
  ...
  spinbutton = picman_spin_button_new (&adj, mapvals.lightsource.direction.z,
                                     -1.0, 1.0, 0.01, 0.1, 0.0, 0.0, 2);
  picman_table_attach_aligned (GTK_TABLE (table), 0, 2,
                             _("Z:"), 0.0, 0.5,
                             spinbutton, 1, TRUE);
...
create_material_page (void)
{
  ...
  frame = picman_frame_new (_("Intensity Levels"));
  gtk_box_pack_start (GTK_BOX (page), frame, FALSE, FALSE, 0);
  gtk_widget_show (frame);
  ...
  frame = picman_frame_new (_("Reflectivity"));
  gtk_box_pack_start (GTK_BOX (page), frame, FALSE, FALSE, 0);
  gtk_widget_show (frame);
  ...
  spinbutton = picman_spin_button_new (&adj, mapvals.material.diffuse_ref,
                                     0, G_MAXFLOAT, 0.1, 1.0, 0.0, 0.0, 2);
  gtk_table_attach (GTK_TABLE (table), spinbutton, 2, 3, 0, 1,
                    GTK_SHRINK | GTK_FILL, GTK_SHRINK | GTK_FILL, 0, 0);
  gtk_widget_show (spinbutton);
...
create_orientation_page (void)
{
  ...
  gtk_size_group_add_widget (group, PICMAN_SCALE_ENTRY_SPINBUTTON (adj));
  gtk_spin_button_configure (PICMAN_SCALE_ENTRY_SPINBUTTON (adj),
                             PICMAN_SCALE_ENTRY_SPINBUTTON_ADJ (adj), 0.01, 5);
  ...
  frame = picman_frame_new (_("Rotation"));
  gtk_box_pack_start (GTK_BOX (page), frame, FALSE, FALSE, 0);
  gtk_widget_show (frame);
...
create_box_page (void)
{
  ...
  frame = picman_frame_new (_("Map Images to Box Faces"));
  gtk_box_pack_start (GTK_BOX (page), frame, FALSE, FALSE, 0);
  gtk_widget_show (frame);
  ...
  for (i = 0; i < 6; i++)
    {
      ...
      combo = picman_drawable_combo_box_new (box_constrain, NULL);
  ...
  adj = picman_scale_entry_new (GTK_TABLE (table), 0, 0,
                              ...
                              _("X scale (size)"), NULL);
  gtk_spin_button_configure (PICMAN_SCALE_ENTRY_SPINBUTTON (adj),
                             PICMAN_SCALE_ENTRY_SPINBUTTON_ADJ (adj), 0.1, 2);
...
create_cylinder_page (void)
{
  ...
  frame = picman_frame_new (_("Images for the Cap Faces"));
  gtk_box_pack_start (GTK_BOX (page), frame, FALSE, FALSE, 0);
  gtk_widget_show (frame);
  ...
  for (i = 0; i < 2; i++)
    {
      ...
      combo = picman_drawable_combo_box_new (cylinder_constrain, NULL);
      picman_int_combo_box_connect (PICMAN_INT_COMBO_BOX (combo),
                                  mapvals.cylindermap_id[i],
                                  G_CALLBACK (picman_int_combo_box_get_active),
                                  &mapvals.cylindermap_id[i]);

      label = picman_table_attach_aligned (GTK_TABLE (table), 0, i,
                                         gettext (labels[i]), 0.0, 0.5,
                                         combo, 1, FALSE);
      gtk_size_group_add_widget (group, label);
    }
...
main_dialog (PicmanDrawable *drawable)
{
  ...
  appwin = picman_dialog_new (_("Map to Object"), PLUG_IN_ROLE,
                            NULL, 0,
  ...
  model = picman_zoom_model_new ();
  picman_zoom_model_set_range (model, 0.25, 1.0);
  picman_zoom_model_zoom (model, PICMAN_ZOOM_TO, mapvals.zoom);

  button = picman_zoom_button_new (model, PICMAN_ZOOM_IN, GTK_ICON_SIZE_MENU);
  gtk_box_pack_end (GTK_BOX (hbox), button, FALSE, FALSE, 0);
  gtk_widget_show (button);

  button = picman_zoom_button_new (model, PICMAN_ZOOM_OUT, GTK_ICON_SIZE_MENU);
  gtk_box_pack_end (GTK_BOX (hbox), button, FALSE, FALSE, 0);
  gtk_widget_show (button);
